...
import com.datastax.autoloader.CsvAutoLoader;
        ...
        session.read(flowfile, new InputStreamCallback() {
            ...
            public void process(InputStream in) throws IOException {
                try{
                    ...
                    CsvAutoLoader autoLoader = new CsvAutoLoader(contactPoint);
                    autoLoader.createTable(in,keyspace,table,delimiter);
                    autoLoader.loadTable(in,keyspace,table,delimiter);
